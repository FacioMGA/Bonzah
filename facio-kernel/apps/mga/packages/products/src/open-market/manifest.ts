...
// Immigration is a Portugal-only public referral intent. Keep it outside the
// generic manifest options so other territories cannot present it as a normal
// Open Market product.
export const OPEN_MARKET_VALIDATED_LINE_OF_BUSINESS_OPTIONS: SelectOption[] = [
  ...OPEN_MARKET_LINE_OF_BUSINESS_OPTIONS,
  { value: 'immigration', label: 'Portugal immigration medical referral' },
];

export const OPEN_MARKET_IMMIGRATION_APPLICATION_OPTIONS: SelectOption[] = [
  { value: 'residency', label: 'Residency application' },
  { value: 'visa', label: 'Visa application' },
  { value: 'renewal', label: 'Residency or visa renewal' },
  { value: 'other', label: 'Other immigration requirement' },
];

export const OPEN_MARKET_IMMIGRATION_RESIDENCY_OPTIONS: SelectOption[] = [
...
export const openMarketManifest: ProductManifest = {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { path: 'risk.immigration.applicationType', label: 'Immigration application type', type: 'select', options: OPEN_MARKET_IMMIGRATION_APPLICATION_OPTIONS },
          { path: 'risk.immigration.countryOfResidence', label: 'Current country of residence', type: 'text' },
          { path: 'risk.immigration.residencyStatus', label: 'Current residency status', type: 'select', options: OPEN_MARKET_IMMIGRATION_RESIDENCY_OPTIONS },
          { path: 'risk.immigration.applicantDetails', label: 'Applicant details', type: 'textarea' },
        ],
      },
      {
        id: 'manual-proposal',
  ...
  documentTypes: {
    ...
    OPEN_MARKET_EXTERNAL_CERTIFICATE_PDF: 'Externally issued certificate',
    OPEN_MARKET_EXTERNAL_SCHEDULE_PDF: 'Externally issued policy schedule',
    OPEN_MARKET_EXTERNAL_POLICY_WORDING_PDF: 'Externally issued policy wording',
  },
