...
import { requireCustomerOwnedDocument } from './requireCustomerOwnedDocument.js';
 ...
 */
router.get('/:filename', documentsAuditLog, requireDocumentFetchPermission(), requireCustomerOwnedDocument, async (req, res) => {
  try {
