...
import { renderCustomerTemplate as renderCustomerTemplateRaw } from '../customerTemplateCatalogService.js';
import { runWithOperatingTenant } from '../../../../platform/tenant/tenantAls.js';
import { getTenantConfig } from '../../../../platform/tenant/tenantConfig.js';
import { runtimeSettingsForProfile } from '../../../platformTenants/infra/templates.js';
const renderCustomerTemplate: typeof renderCustomerTemplateRaw = (...args) => runWithOperatingTenant({ ...getTenantConfig(), runtimeSettings: runtimeSettingsForProfile({ displayName: 'Synthetic MGA', legalName: 'Synthetic MGA', locale: 'en-GB', timeZone: 'Asia/Nicosia', declaredRole: 'MGA', addressLines: ['Synthetic office'], contactEmail: 'training@example.invalid', contactPhone: '+35700000000' }) }, () => renderCustomerTemplateRaw(...args));
import {
