/** Exact historical development underwriting values from pinned f852194 backend/test/fixtures/motor/underwriting.ts. Explicit opt-in synthetic provisioning only; each tenant receives a published immutable copy. No runtime fallback or customer authority. */
export const SYNTHETIC_MOTOR_UNDERWRITING_V1 = {
