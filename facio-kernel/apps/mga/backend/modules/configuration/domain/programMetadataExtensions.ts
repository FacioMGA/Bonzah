 ...
 * historical Config MCP V1 publisher. ADR-0101 supersedes these slots for
 * runtime behaviour; they remain only to parse existing draft evidence.
 */
...
// Historical closed allowlist retained only to parse existing draft evidence.
// ---------------------------------------------------------------------
