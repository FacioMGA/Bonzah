...
export const MotorUwOverridesSchema = z
    .object({
        ...
        supportedVehicleTypeTokens: z.array(z.string().min(1)).optional(),
        motorcycleAllowedVehicleUses: z.array(z.string().min(1)).optional(),
        motorcycleAllowedCoverRequired: z.array(z.string().min(1)).optional(),
        motorcycleDisallowedDriverRestrictions: z.array(z.string().min(1)).optional(),
...
function mergeUwOverrides(a?: MotorUwOverrides, b?: MotorUwOverrides): MotorUwOverrides | undefined {
    ...
    return {
        ...
        supportedVehicleTypeTokens: b?.supportedVehicleTypeTokens ?? a?.supportedVehicleTypeTokens,
        motorcycleAllowedVehicleUses: b?.motorcycleAllowedVehicleUses ?? a?.motorcycleAllowedVehicleUses,
        motorcycleAllowedCoverRequired: b?.motorcycleAllowedCoverRequired ?? a?.motorcycleAllowedCoverRequired,
        motorcycleDisallowedDriverRestrictions: b?.motorcycleDisallowedDriverRestrictions ?? a?.motorcycleDisallowedDriverRestrictions,
