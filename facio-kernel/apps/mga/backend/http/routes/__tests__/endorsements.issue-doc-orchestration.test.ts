...
const resolveImmutablePolicyDocumentConfigurationMock = vi.fn(async (..._args: unknown[]) => ({
...
vi.mock('../../../modules/policy/app/productRegistryService.js', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../../../modules/policy/app/productRegistryService.js')>()),
