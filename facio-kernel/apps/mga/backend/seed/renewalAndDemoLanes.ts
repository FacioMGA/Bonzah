...
export async function seedRenewalAndDemoLanes(args: {
  ...
  const renewalQuoteResponse = calculateAutoInsuranceQuoteResponse(renewalQuoteData, undefined, seedMotorQuoteOptions(renewalQuoteData, policyRenewalInProgressNumber));
