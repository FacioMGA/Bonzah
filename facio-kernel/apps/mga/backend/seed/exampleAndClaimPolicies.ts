...
export async function seedExampleAndClaimPolicies(args: {
  ...
  const activeQuoteResponse = calculateAutoInsuranceQuoteResponse(activeQuoteData, undefined, seedMotorQuoteOptions(activeQuoteData, policyActiveNumber));
  ...
  const issuedQuoteResponse = calculateAutoInsuranceQuoteResponse(issuedQuoteData, undefined, seedMotorQuoteOptions(issuedQuoteData, policyIssuedNumber));
  ...
  const cancellationQuoteResponse = calculateAutoInsuranceQuoteResponse(cancellationQuoteData, undefined, seedMotorQuoteOptions(cancellationQuoteData, policyCancellationPendingNumber));
  ...
  const claimQuoteResponse = calculateAutoInsuranceQuoteResponse(claimQuoteData, undefined, seedMotorQuoteOptions(claimQuoteData, policyWithClaimNumber));
