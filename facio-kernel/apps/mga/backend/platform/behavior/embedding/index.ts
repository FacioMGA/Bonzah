...
export function getEmbedder(): Embedder {
  if (process.env.KERNEL_PLATFORM_MODE === 'true' && process.env.KERNEL_BEHAVIOR_EMBEDDINGS_ENABLED !== 'true') {
    throw new Error('Behavior embeddings are not configured for this deployment.');
  }
