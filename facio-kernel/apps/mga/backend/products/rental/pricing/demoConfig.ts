...
export const BONZAH_DEMO_RULES = {
  ...
  coverages: {
    ...
    PAI_PEI: { label: 'Personal Accident / Effects Protection (PAI/PEI)', limit: 'Renter life $50,000 · Passenger life $5,000 · Medical $1,000 · Effects $525', deductible: '$25 on personal effects', exclusions: 'Covers accidental life, medical expenses and personal effects. It does not cover rental-vehicle damage.' },
