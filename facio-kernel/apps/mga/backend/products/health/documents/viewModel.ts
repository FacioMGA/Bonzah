...
const DEFAULT_POLICY_VERSION = 'IM/01';
...
export function buildHealthDocViewModel(ctx: DocPackContext): UnknownRecord {
  ...
  return {
    ...
    coverholderTelephone: tenantIdentity.contact.phone,
    coverholderFax: '',
    ...
    baseCover: {
      ...
      outpatientPerIllnessDisplay: `€${moneyDisplayInt(baseCover.outpatientPerIllness)}`,
      outpatientPerPeriodDisplay: `€${moneyDisplayInt(baseCover.outpatientPerPeriod)}`,
      outpatientExcessDisplay: `€${moneyDisplayInt(baseCover.outpatientExcess)}`,
      coinsurancePercentDisplay: `${baseCover.coinsurancePercent}%`,
    },
