...
import { loadBritHealthRates } from '../data/loader.js';
...
const HEALTH_RATES = loadBritHealthRates();

function rate(data: Parameters<typeof calculateHealthPremium>[0]) {
  return calculateHealthPremium(data, HEALTH_RATES);
}
