...
import { calculateTravelPremium as calculateTravelPremiumWithRates, type TravelQuoteData } from '../travelCalculator.js';
...
describe('travel prior-claims loading + referral (ADR-0054)', () => {
  it('loads the canonical 15% up-to-€500 rate from the BRIT travel JSON', () => {
    const loading = TRAVEL_RATING_TABLES.rateCard.priorClaimLoading;
