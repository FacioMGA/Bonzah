...
// connection module (e.g. through a DB-backed application repository) need a syntactically
...
if (typeof document === 'undefined') {
  ...
  enterOperatingTenantForTest({
    ...
    runtimeSettings: {
      schemaVersion: 'tenant-runtime-v1', locale: 'en-GB', timeZone: 'Europe/Nicosia',
      organization: { declaredRole: 'MGA' }, contact: { email: 'service@training.invalid', phone: '+357 20000000' },
      routing: { underwritingReferralTo: ['underwriting@training.invalid'], underwritingReferralCc: [], onlinePolicyConfirmationCopies: [] },
      branding: { displayName: 'Training MGA', legalName: 'Training Insurance Limited', addressLines: ['1 Training Street'],
        legalLines: ['Training documents only. No insurance cover.'], regulatorLine: null, websiteUrl: null, websiteLabel: null },
    },
  });
}
