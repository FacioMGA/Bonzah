...
export function IssuedPremiumSummary(props: {
  ...
  const assistanceFee = premiumAmount(breakdown.europAssistanceFee);
      ...
      <div className="overflow-auto">
        <table className="ui-table">
          ...
          <tbody className="ui-tbody text-sm">
            ...
            {assistanceFee !== 0 && (
              <tr className="ui-row bg-white/0">
                <td className="px-10 py-6 font-black text-slate-900">Home Emergency Assistance Fee</td>
                <td className="px-10 py-6"><AmountCell n={assistanceFee} currency={currency} /></td>
              </tr>
            )}
            {extrasTotal > 0 && (
              <tr className="ui-row bg-white/0">
