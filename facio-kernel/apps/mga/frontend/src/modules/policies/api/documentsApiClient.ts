...
export const documentsApiClient = {
    ...
    async retryIssuedPack(policyId: string) {
        return http.request<{eventId:string;status:'queued'}>(`policies/${encodeURIComponent(policyId)}/documents/retry-issued-pack`, {method:'POST',body:JSON.stringify({})});
    },
