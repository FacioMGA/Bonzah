...
import { TenantWorkspaceControl } from '@/src/modules/workspaces';
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-brand-canvas">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full">
        ...
        <div className="lg:hidden px-4 py-3 border-b border-slate-200"><TenantWorkspaceControl compact /></div>

        {/* Desktop header — hidden on mobile (MobileTopBar replaces it) */}
        <header className="hidden lg:flex sticky top-0 z-50 items-center justify-between gap-4 h-20 px-10 bg-brand-canvas border-b border-slate-900/5 shadow-none shrink-0">
