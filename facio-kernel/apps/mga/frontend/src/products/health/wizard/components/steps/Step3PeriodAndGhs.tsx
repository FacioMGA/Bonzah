        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-slate-600 mt-1 mb-3">
              GESY beneficiaries unlock the no-premium doctor visits & medications extension on this policy. Standard inpatient, outpatient and repatriation cover is included for all Immigration policies.
            </div>
            <FormField
