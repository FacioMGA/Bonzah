...
export function Step1Eligibility() {
  ...
  return (
    <SectionCard title="Eligibility" icon={<Globe className="w-5 h-5" />}>
      ...
      {/* Legal authority is supplied by the configured policy pack, never inferred from a tenant name. */}
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 space-y-3 text-sm text-slate-600 leading-relaxed">
        <p>
          Insurer, issuing organization and governing law must be confirmed in the configured policy documents before purchase. A workspace profile does not establish insurer or coverholder authority.
        </p>
