      ...
      slots={{
        primary: (
          ...
          <PremiumCard
            ...
            footnotePrimary="This is a quote. Coverage begins only after the policy is bound under its stated terms."
          />
          <p className="text-center mt-3 text-xs text-slate-600">
            Review the retained quote and policy documents in the operating workspace. Document delivery depends on the configured communication services.
          </p>
          </>
        ),
        sidebar: (
