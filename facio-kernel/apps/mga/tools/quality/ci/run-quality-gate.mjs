...
async function main() {
  ...
  try {
    ...
    run('audit_prod_critical_tests', 'npm run test:audit:prod:critical');
    ...
    run('runtime_artifacts_regression', 'node --test tools/quality/__tests__/verify-runtime-artifacts.test.mjs');
