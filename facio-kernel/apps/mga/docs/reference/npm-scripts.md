...
| `audit:prod:critical` | `node tools/quality/run-production-critical-audit.mjs` |
...
| Script | Command |
|--------|---------|
| `check:platform` | `npm run build && tsc -p frontend/tsconfig.json --noEmit && npm run test:platform` |
...
| `dev:api` | `node tools/platform/with-env.mjs tsx watch apps/api/index.ts` |
...
| `test:audit:prod:critical` | `node --test tools/quality/tests/run-production-critical-audit.test.mjs` |
...
| `test:platform` | `vitest --config frontend/vitest.config.ts run backend/modules/platformTenants/__tests__ backend/modules/platformIdentity/__tests__ backend/modules/insuranceConfiguration/__tests__ backend/products/commercial/__tests__ backend/platform/db/__tests__/tenantExtension.test.ts backend/platform/tenant/__tests__/platformJobSuspension.test.ts frontend/src/modules/workspaces/__tests__ frontend/src/modules/insuranceConfiguration frontend/src/shared/lib/__tests__/operatingCountry.test.ts frontend/src/shared/lib/observability/sentry.test.ts frontend/src/shared/lib/marker/markerProjects.test.ts frontend/src/surfaces/bo/layout/components/Sidebar.test.tsx frontend/src/shared/lib/wizard/__tests__/sessionAdapter.contract.test.ts frontend/src/products/home/wizard/__tests__/useHomeQuoteWizardController.test.tsx frontend/src/modules/policies/policyholder/views/PolicyholderTab.test.tsx frontend/src/shared/lib/wizard/steps/PaymentCapabilityGate.test.tsx frontend/src/modules/policies/premium/actions/PremiumActions.test.tsx frontend/src/products/__tests__/catalog.availability.test.ts frontend/src/modules/policies/underwriting/renderers/__tests__/QuestionnaireSection.vehicleTrim.test.tsx frontend/src/shared/lib/wizard/__tests__/issueReadinessClient.test.ts frontend/src/shared/lib/wizard/components/ManualProposalQuoteView.test.tsx frontend/src/modules/policies/premium/renderers/PremiumTotalsRows.test.tsx frontend/src/surfaces/public/pages/RegisteredProductGate.test.tsx frontend/src/modules/policies/hooks/usePolicyController.test.ts frontend/src/modules/policies/documents/model/documentsGrouping.test.ts frontend/src/modules/policies/documents/views/DocumentsTab.test.tsx frontend/src/modules/policies/documents/hooks/usePolicyDocumentsTab.test.tsx frontend/src/surfaces/bo/router.test.tsx backend/products/shared/documents/__tests__/tenantDocumentSelection.test.ts backend/modules/policy/app/__tests__/retryIssuedPolicyDocuments.test.ts backend/workers/handlers/__tests__/DOC.GENERATE_ISSUED_POLICY_PACK.test.ts backend/products/home/documents/__tests__/viewModel.test.ts backend/products/home/documents/__tests__/templates_render_smoke.test.ts backend/products/travel/documents/__tests__/viewModel.test.ts frontend/src/modules/policies/premium/views/IssuedPremiumSummary.test.tsx frontend/src/products/home/wizard/__tests__/paymentSummary.test.ts frontend/src/surfaces/bo/PlatformEntry.test.tsx backend/platform/http/__tests__/contentSecurityPolicy.test.ts frontend/src/modules/policies/premium/renderers/PremiumPricingBreakdown.test.tsx frontend/src/modules/policies/config/sourceQuestionScope.test.ts frontend/src/modules/policies/config/questionnaires.test.ts frontend/src/modules/policies/underwriting/model/questionnaireProjection.test.ts backend/modules/claims/http/__tests__/clientClaimsRouter.test.ts backend/modules/claims/http/__tests__/publicFnolRouter.test.ts backend/modules/documents/http/__tests__/requireCustomerOwnedDocument.test.ts backend/modules/documents/http/__tests__/documentsRouter.test.ts backend/http/routes/__tests__/clientDocuments.surface.test.ts backend/http/routes/__tests__/cancellations.test.ts` |
