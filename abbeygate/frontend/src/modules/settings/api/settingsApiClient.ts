...
export const settingsApiClient = {
    ...
    async getProductChannels() {
        return http.request<Record<string, { questions: boolean; quote: boolean; payment: boolean }>>('product-channels');
    },

    async updateProductChannel(productCode: string, switches: { questions: boolean; quote: boolean; payment: boolean }) {
        return http.request<Record<string, { questions: boolean; quote: boolean; payment: boolean }>>(`product-channels/${productCode}`, {
            method: 'PUT',
