        ...
        actions={
          submissionSuccess ? (
            ...
            <>
              ...
              <Button type="button" variant="primary" size="md" onClick={handleCreateSubmission} disabled={!newQuote.productType} className="bg-brand-primary text-white px-8 py-3 rounded-xl font-black shadow-lg hover:bg-brand-secondary transition disabled:opacity-50">Create Submission</Button>
            </>
          )
        }
      >
        {submissionSuccess ? (
          <div className="flex flex-col items-center justify-center p-10 text-center">
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 w-full">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-black text-slate-800">${newQuote.premium || '0'}</span>
              </div>
            </div>
          </div>
        ) : (
          <div className="p-2 space-y-6">
            <div className="bg-brand-primary/5 p-6 rounded-2xl border border-brand-primary/10 mb-6">
              ...
              <p className="text-xs text-brand-primary/80">This will initiate a new policy lifecycle. Underwriters will be notified immediately.</p>
            </div>
