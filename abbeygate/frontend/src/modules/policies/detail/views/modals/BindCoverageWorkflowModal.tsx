...
interface BindCoverageWorkflowModalProps {
    isOpen: boolean;
    onClose: () => void;
    isIssuingPolicyFinal: boolean;
    isCreatingDraft: boolean;
    onCreateDraft: () => void;
    onIssuePolicyFinal: () => void;
}

export function BindCoverageWorkflowModal({
    isOpen,
    onClose,
    ...
    onCreateDraft,
    onIssuePolicyFinal,
}: BindCoverageWorkflowModalProps) {
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
                ...
                isIssuingPolicyFinal ? (
                    ...
                    <>
                        ...
                        <Button
                            ...
                            disabled={isCreatingDraft || isIssuingPolicyFinal}
                        >
                        ...
                        <Button
                            ...
                            disabled={isIssuingPolicyFinal || isCreatingDraft}
                        >
                            Issue policy
                        </Button>
                    </>
                ...
                <div className="p-4">
                    <div className="mx-auto max-w-contentNarrow">
                        ...
                        <div className="mt-4 text-center">
                            <div className="text-slate-900 font-black text-lg tracking-tight">Minting the policy pack</div>
                            <div className="mt-1 text-sm text-slate-600 font-medium">Sealing wording, signing terms, and preparing the smart policy.</div>
                        </div>
            ...
            `}</style>
                ...
                <div className="p-4 text-center sm:text-left space-y-3">
                    <p className="text-slate-600 font-medium">
                        You're about to bind coverage. Would you like to review a draft policy or issue the final policy documents?
                    </p>
                    <p className="text-xs text-slate-500">
                        Draft documents are watermarked and are not sent externally. Issuing will generate final documents, lock wording and
                        calculations, and send them to the customer/broker.
                    </p>
                </div>
            )}
        </Modal>
