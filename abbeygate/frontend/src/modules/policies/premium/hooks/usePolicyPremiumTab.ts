  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const resp = await pricingApiClient.calculateProductPremium(qd as Record<string, unknown>, baselineExcess) as {
          success?: boolean;
          data?: { primaryOption?: { costDetails?: { totalPremium?: number }; annualPremium?: number } };
