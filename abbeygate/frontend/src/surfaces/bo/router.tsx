...
function renderBoRoutes({ wrapProtected, dashboardProps }: BoSurfaceRoutesProps) {
  return (
    <>
      ...
      <Route path="/configure/programs" element={wrapProtected(<ProgramsPage />)} />
      <Route path="/configure/programs/:id" element={wrapProtected(<ProgramsPage />)} />
      <Route path="/configure/product-channels" element={wrapProtected(<ProductChannelsPage />)} />
