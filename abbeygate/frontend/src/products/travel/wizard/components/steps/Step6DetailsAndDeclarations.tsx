    ...
    <div className="lg:grid lg:grid-cols-[1fr_240px] lg:gap-6 lg:items-start">
      <div className="space-y-4">
        ...
        <SectionCard title="Very Important Notice" icon={<ClipboardCheck className="w-3.5 h-3.5" />}>
          ...
          <p className="text-[13px] text-slate-600 leading-relaxed">
            Abbeygate Insurance policies do not cover certain pre-existing medical conditions.
          ...
          <div className="space-y-3 pt-1">
            ...
            <Checkbox
              ...
              label={
                <>
                  Before Proceeding To Purchase A Abbeygate Policy Please Also Confirm You Have
          ...
          <p className="text-[12px] text-slate-500 leading-relaxed border-t border-slate-100 pt-3">
            ...
            shared with other stakeholders. Please see our{' '}
            <a href="#" className="text-brand-primary underline hover:no-underline">TOBA</a>{' '}
            for more detail. You have the right to request that we delete your personal data from
        ...
        */}
        ...
        <SectionCard title="Your Contact Preferences" icon={<Bell className="w-3.5 h-3.5" />}>
          <div className="space-y-2" data-field="proposer.marketingConsent" id="field-proposer.marketingConsent">
            <p className="text-[13px] text-slate-700 leading-relaxed">
              ...
              you would like to opt in to receive information from Abbeygate
            </p>
            <Controller
        ...
        <SectionCard title="Declaration" icon={<ClipboardCheck className="w-3.5 h-3.5" />}>
          ...
          <Checkbox
            ...
            label="I Confirm That I Have Read And Understood The Above Information And I Wish To Proceed To The Payment Portal To Purchase A Abbeygate Policy."
