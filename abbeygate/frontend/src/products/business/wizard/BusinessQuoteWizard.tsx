    ...
    return (
      <div className="brand-flow min-h-screen overflow-x-hidden bg-white text-black font-sans">
        ...
        <SuccessScreen
          variant="pending"
          headline="Thank you"
          subline={`${proposerRecord.firstName ? `Thanks, ${String(proposerRecord.firstName)}.` : 'Thank you.'} Someone from Abbeygate will contact you about your business insurance request.`}
