...
export abstract class BaseManifestProductAdapter implements IProductAdapter {
  ...
  protected constructor(
    ...
    private readonly defaultClaimsContract: ClaimsContract,
    private readonly requiredIssuedDocTypes: string[],
  ) {}
  ...
  getRequiredIssuedDocTypes(): string[] {
    return [...this.requiredIssuedDocTypes];
  }
  ...
  getDefaultClaimsContract(): ClaimsContract {
    return this.defaultClaimsContract;
  }
  ...
  abstract buildQuoteResponse(quoteData: unknown, programMeta: unknown, context?: BuildQuoteResponseContext): Promise<QuoteResponseResult>;
  ...
  abstract getRatingMatrixSnapshot(): Promise<Record<string, unknown> | null>;
