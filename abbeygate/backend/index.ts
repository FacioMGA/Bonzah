...
import { ensureConfigMcpDemoSandboxTenant } from './modules/configuration/infra/syntheticTenantSeed.js';
...
app.use(helmet({
  ...
  // Disable CSP in dev to reduce local friction.
...
app.use((req: Request, res: Response, next: NextFunction) => {
  ...
  const allowedOrigins = [
    'https://developers.facio.io',
    // Production public domains (abbeygate.com).
    'https://cy.abbeygate.com',
    'https://pt.abbeygate.com',
    'https://gr.abbeygate.com',
    // Test / staging domains.
    'https://cy.staging.abbeygate.com',
    'https://pt.staging.abbeygate.com',
    'https://gr.staging.abbeygate.com',
    // Legacy facio.io hosts — kept live through the domain transition.
    'https://abbeygate-cy.facio.io',
    'http://abbeygate-cy.facio.io',
    'https://abbeygate-pt.facio.io',
    'http://abbeygate-pt.facio.io',
    'https://abbeygate-gr.facio.io',
    'http://abbeygate-gr.facio.io',
    process.env.CORS_ORIGIN,
    // Local dev defaults (avoid “Operation failed. Ensure backend is running.”)
    'http://localhost:5173',
    'http://127.0.0.1:5173',
    'http://localhost:5174',
    'http://127.0.0.1:5174',
  ...
  const allowOrigin = origin && (allowedOrigins.includes(origin) || isDev);
  ...
  try {
    ...
    void runNonHttpBootstraps({
      ...
      ensureDefaultProgram: async () => {
        ...
        // Config MCP V1 (ADR-0036 / ADR-0037) — ensure the SYNTHETIC
        // sandbox tenant exists so publishToSandbox has a target.
        await ensureConfigMcpDemoSandboxTenant();
      },
