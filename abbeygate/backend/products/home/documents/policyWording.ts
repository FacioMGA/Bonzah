...
// ---------------------------------------------------------------------------
// The IPID does not vary by domicile, only by territory. Cyprus uses the
// combined Cyprus/Greece Beazley IPID, Portugal uses the approved
// Spain/Portugal IPID, and Greece has its own Lloyd's Greece IPID.
...
const HOME_IPID_CYPRUS_GREECE_COMBINED: HomeIpidAsset = {
  ...
  assetVersion: 'beazley-home-ipid-cyprus-greece-with-subsidence:2023',
};

const HOME_IPID_GREECE: HomeIpidAsset = {
  filename: 'Home_IPID_Lloyds_Greece.pdf',
  staticPdfPath: path.join(HOME_STATIC_DIR, 'LloydsHome_IPID_GR.pdf'),
  assetVersion: 'lloyds-home-ipid-greece:v1',
};
