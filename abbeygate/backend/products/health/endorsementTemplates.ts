  ...
  return [
    {
      ...
      summary: 'Base Section A cover — inpatient care, daily hospitalisation, childbirth, and repatriation. Excess varies by insured age band.',
      type: 'COVERAGE',
      scope: 'POLICY',
      jurisdiction: ['CY'],
      legal_text:
    ...
    },
    {
      ...
      title: 'GESY Outpatient + Repatriation Extension',
      summary: 'Outpatient cover (medicine, surgical operations, doctor visits, medications) and Death by Accident / Repatriation, available only to GESY beneficiaries.',
      ...
      legal_text:
        ...
        `Outpatient maximum per Illness EUR ${ghsExtension.outpatientPerIllness.toLocaleString('en-IE')}; per Period EUR ${ghsExtension.outpatientPerPeriod.toLocaleString('en-IE')}; ` +
        `co-insurance ${ghsExtension.coinsurancePercent}%. No additional premium.`,
      parameters_schema: {
        type: 'object',
        properties: {
      ...
      default_params: {
        outpatientPerIllness: ghsExtension.outpatientPerIllness,
        outpatientPerPeriod: ghsExtension.outpatientPerPeriod,
        ...
        outpatientExcess: ghsExtension.outpatientExcess,
        coinsurancePercent: ghsExtension.coinsurancePercent,
      },
      rules: {
        prerequisites: [],
        exclusions: [],
