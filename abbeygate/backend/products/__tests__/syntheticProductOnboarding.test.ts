  ...
  it('supports a new product through runtime definition plus controlled extension only', async () => {
    const syntheticDefinition: ProductRuntimeDefinition = {
      ...
      defaultClaimsContract: {
        ...
        productType: 'GADGET',
        fnol: {
          incidentTypes: [{ id: 'damage', label: 'Damage', thirdPartyStep: false }],
          thirdPartyKinds: [],
          rules: {
      ...
      requiredIssuedDocTypes: ['GADGET_SCHEDULE_PDF'],
      ...
      engines: {
        rating: {
          ...
          getRatingMatrixSnapshot: async () => ({ source: 'synthetic', sheet: 'default' }),
