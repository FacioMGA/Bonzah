...
import { createBonzahPartnerRouter } from '../../../modules/bonzah/http/bonzahRouter.js';
...
// ADR-0094: demo-only partner façade. It owns bearer/partner authentication
// and is mounted before the platform API-key middleware intentionally.
v1Router.use('/bonzah', createBonzahPartnerRouter());
